-- DRAFT ONLY
-- DO NOT APPLY
-- The frontend legacy fallback must be implemented and verified first.
-- This file is not a registered migration and must not be placed in
-- supabase/migrations/. If it is ever promoted for deployment, it depends on
-- 20260715165129_harden_public_rpc_privileges.sql.
-- This draft replaces function definitions only; it does not modify rows or
-- table structure.
