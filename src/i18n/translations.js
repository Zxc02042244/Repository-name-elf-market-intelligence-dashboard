const en = {
  ...
  elfLanding: {
    ...
    skinSyncStatusTitle: "Wish sync status",
    skinSyncSynced: "Your wishes are synced.",
    skinSyncLocalOnly: "Saved on this device. Cloud sync is temporarily unavailable.",
    skinSyncCredentialRotated: "A new anonymous sync identifier was created safely. Your local wishes were kept.",
    skinSyncRetryFailed: "Sync could not be completed. Your local wishes are still saved.",
    skinDeleteUnverified: "Deletion could not be verified. Your local wishes and sync credential were kept.",
...
const zhHant = deepMerge(en, {
  ...
  elfLanding: {
    ...
    skinSyncStatusTitle: "願望同步狀態",
    skinSyncSynced: "願望已同步。",
    skinSyncLocalOnly: "願望已儲存在此裝置；雲端同步暫時無法使用。",
    skinSyncCredentialRotated: "系統已安全建立新的匿名同步識別；本機願望未受影響。",
    skinSyncRetryFailed: "同步尚未完成；本機願望仍安全保留。",
    skinDeleteUnverified: "無法確認社群資料已刪除；本機願望與同步憑證仍保留。",
...
const ja = deepMerge(en, {
  elfLanding: {
    ...
    skinSyncStatusTitle: "願いリストの同期状態",
    skinSyncSynced: "願いリストは同期済みです。",
    skinSyncLocalOnly: "この端末には保存されました。クラウド同期は一時的に利用できません。",
    skinSyncCredentialRotated: "新しい匿名の同期識別子を安全に作成しました。端末内の願いは保持されています。",
    skinSyncRetryFailed: "同期を完了できませんでした。端末内の願いは保持されています。",
    skinDeleteUnverified: "コミュニティデータの削除を確認できませんでした。端末内の願いと同期情報は保持されています。",
...
const ko = deepMerge(en, {
  elfLanding: {
    ...
    skinSyncStatusTitle: "위시 동기화 상태",
    skinSyncSynced: "위시가 동기화되었습니다.",
    skinSyncLocalOnly: "이 기기에는 저장되었습니다. 클라우드 동기화를 일시적으로 사용할 수 없습니다.",
    skinSyncCredentialRotated: "새 익명 동기화 식별자를 안전하게 만들었습니다. 로컬 위시는 유지되었습니다.",
    skinSyncRetryFailed: "동기화를 완료하지 못했습니다. 로컬 위시는 안전하게 유지됩니다.",
    skinDeleteUnverified: "커뮤니티 데이터 삭제를 확인하지 못했습니다. 로컬 위시와 동기화 정보는 유지되었습니다.",
...
const vi = deepMerge(en, {
  elfLanding: {
    ...
    skinSyncStatusTitle: "Trạng thái đồng bộ lựa chọn",
    skinSyncSynced: "Các lựa chọn đã được đồng bộ.",
    skinSyncLocalOnly: "Đã lưu trên thiết bị này. Đồng bộ đám mây tạm thời không khả dụng.",
    skinSyncCredentialRotated: "Một mã nhận dạng đồng bộ ẩn danh mới đã được tạo an toàn. Các lựa chọn cục bộ vẫn được giữ.",
    skinSyncRetryFailed: "Chưa thể hoàn tất đồng bộ. Các lựa chọn cục bộ vẫn an toàn.",
    skinDeleteUnverified: "Không thể xác nhận dữ liệu cộng đồng đã được xóa. Các lựa chọn và thông tin đồng bộ cục bộ vẫn được giữ.",
